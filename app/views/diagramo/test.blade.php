...
<html>
    ...
    <head>
        ...
        <!--[if IE]>
        <script src="{{asset('assets/diagramo/diagramo/web/editor/') }}./assets/javascript/excanvas.js"></script>
        <![endif]-->
    ...
    <body onload="initLight('');" id="body">
        ...
        <div id="header">    
            <span>
                <img src="{{asset('assets/diagramo/diagramo/web/editor/assets/images/logo_36h_full.png') }}"/>
            </span>            
        </div>
...
//                    }
        ...
        <div id="import-dialog" style="background-color: white; display: none; margin-top: auto; margin-bottom: auto;">
            <form action="./common/controller.php" method="POST" enctype="multipart/form-data">
                ...
                <p/>
                <input type="image" src="{{asset('assets/diagramo/diagramo/web/editor/assets/images/import.gif') }}"/>
            </form>
        </div>
